...
import com.example.db_springdataintro.model.entity.*;
import com.example.db_springdataintro.repository.BookRepository;
...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<String> findAllBooksByFirstNameAndLastNameOrderByReleaseDate(String firstName, String lastName) {
return bookRepository
